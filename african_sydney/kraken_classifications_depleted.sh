...
#SBATCH -o /gpfs/home/hce24xau/scratch/gen_kmers/data/african_sydney/job_outputs/krakenuniq_batch1_depleted_%j.out
#SBATCH -e /gpfs/home/hce24xau/scratch/gen_kmers/data/african_sydney/job_errors/krakenuniq/krakenuniq_batch1_depleted_%j.err
#SBATCH -p hmem
#SBATCH --qos=hmem
#SBATCH --mem=2000GB
...
INDIR="$BASE/output_files/hdist_0_mm_f/clean"
OUTDIR="$BASE/kraken_outputs/panhuman_depletion_outputs"
REPDIR="$BASE/kraken_reports/panhuman_depletion_reports"
