...
#SBATCH --cpus-per-task=40                      # Use 64 CPU cores
...
# Define paths
INPUT_KMERS="/gpfs/home/hce24xau/scratch/gen_kmers/data/chinese_pan_genome/filtered_assembly/filtered_chinese_pan.fasta"
OUTPUT_PREFIX="/gpfs/home/hce24xau/scratch/gen_kmers/data/chinese_pan_genome/filtered_assembly/filtered_chinese_pan"
TMP_DIR="/gpfs/home/hce24xau/scratch/gen_kmers/data/chinese_pan_genome/filtered_assembly/tmp"
